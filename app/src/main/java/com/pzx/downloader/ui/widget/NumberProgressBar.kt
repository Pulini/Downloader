...
class NumberProgressBar @JvmOverloads constructor(
    ...
    private fun measure(measureSpec: Int, isWidth: Boolean): Int {
        ...
        val padding =
            if (isWidth) paddingLeft + paddingRight else paddingTop + paddingBottom
    ...
    init {
        ...
        progress = attributes.getInt(
            R.styleable.NumberProgressBar_progress_current,
            0
        )
